function plotStem(lim_ejes1,lim_ejes2, eje_x1, eje_y1, eje_x2, eje_y2, titulo1, titulo2, tam_letra, col, grosor, n1, x1, n2, x2)
    % stemCompleto(lim_ejes,eje_x,eje_y,titulo,tam_letra,col,grosor,t,x)
    %
    ...
    xlabel(eje_x1,'Interpreter','Latex'); % Nombro el eje x.
    ylabel(eje_y1,'Interpreter','Latex'); % Nombro el eje x.
    ...
    view(0, 90); % Sitúa la gráfica en el eje real
    xlabel(eje_x2,'Interpreter','Latex'); % Nombro el eje x.
    ylabel(eje_y2,'Interpreter','Latex'); % Nombro el eje x.
    set(gca,'FontSize', tam_letra); % Tama~no de letra para la leyenda y ejes.
