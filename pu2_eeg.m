...
%% RITMO ALFA
% e_eeg_f=eeg_f.^2;
% plotCompleto([0 t(end) 0 max(e_eeg_f)+5], 't[s]', '', 'Energía del encefalograma', 20, 'r-', 1, t, e_eeg_f);
% 
...
plotCompleto([0 t_d(end) 0 max(e_y)*1.1], 't[s]', '', 'Energía del encefalograma diezmado', 20, 'r', 1.5, t_d, e_y);
